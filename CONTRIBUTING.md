...
4. **UI binds loopback only** (`127.0.0.1:8874`). One primary action: Run check. Load example, Import, Export, and Verify stay under Advanced. Do not listen on `0.0.0.0` from `trajectorylock ui`. No telemetry. No CDN.
